...
generation_config="/home/ailab/files/Meta-Llama-3.1-8B-bnb-4bit/config.json" 
prompts = [
    "Hello, my name is",
...
model_path = "/home/ailab/files/Meta-Llama-3.1-8B-bnb-4bit"
...
for i in range(10):
    with torch.no_grad(): # for inferencing: Memory Efficiency, Speed Improvement, Safety
        ...
        start_event.record()
        # Adjust sampling parameters for efficiency
        outputs = model.generate(**inputs, max_length=4436, temperature=temp, top_p=0.9, do_sample=True)
