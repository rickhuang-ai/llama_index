...
generation_config="/home/ailab/files/mistral-7b-instruct-v0.3-bnb-4bit/config.json" 
prompts = [
    "Hello, my name is",
...
model_path = "/home/ailab/files/mistral-7b-instruct-v0.3-bnb-4bit"
...
outputs = model.generate(inputs, max_length=1024, temperature=0.3, top_p=0.9, do_sample=True)
...
for i in range(10):
    with torch.no_grad(): # for inferencing: Memory Efficiency, Speed Improvement, Safety
        ...
        start_event.record()
        # Adjust sampling parameters for efficiency
        outputs = model.generate(**inputs, max_length=15436, temperature=temp, top_p=0.9, do_sample=True)
